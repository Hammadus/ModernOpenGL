...
Shader::Shader(const std::string& fileName)
{
	...
	CheckShaderError(m_program, GL_VALIDATE_STATUS, true, "Error: Program failed to link: ");
}
...
static GLuint CreateShader(const std::string& text, GLenum shaderType)
{
	...
	CheckShaderError(shader, GL_COMPILE_STATUS, false, "Error: Sahder loading failed ");
